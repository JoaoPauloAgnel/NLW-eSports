                ...
                <form onSubmit={handleCreateAd} className='mt-8'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <select
                            ...
                            defaultValue=""
                        >
                            <option disabled value="">Qual o game?</option>
                    ...
                    <div className='grid grid-cols-2 gap-6'>
                        <div className='flex flex-col gap-2'>
                            <label htmlFor='yearsPlayinh'>Joga há quantos anos?</label>
                    ...
                    <footer className=' mt-4 flex justify-end gap-4'>
                        ...
                        <button
                            type='submit'
                            className='bg-violet-500 px-5 h-12 rounded-md font-semibold flex items-center gap-3 hover:bg-zinc-600'
                        >
